    ...
    <div class="accordion-item">
        <h2 class="accordion-header style-title" id="head1">
            <button class="accordion-button gap-3" type="button"
                ...
                <span class="fw-bold azul style-title">Descreva o perfil do seu espaço</span>
            </button>
        </h2>
                    ...
                    <div class="col-md-6">
                        <label class="form-label azul lil paragrafo" for="qtd_amb">
                            ...
                            <img src="images/info.svg" height="18" alt="info"
                                ...
                                title="Informe o número de cômodos que receberão intervenção.
  Ex.: sala de estar, sala de jantar e cozinha → 3 ambientes">
        ...
        quartos de 20m² cada → responda 40.">
                        ...
                        <div class="unit-input">
                            ...
                            <div class="invalid-feedback">Informe pelo menos 1 metro.</div>
                        </div>
                ...
                <div class="row g-3 align-items-center mb-4">
                    ...
                    <label class="form-label azul col-md-2 mb-0 text-start">
                        <strong>Um pouco<br>sobre você!</strong>
                    </label>

                    <div class="col-md-3">
                        <input id="nome" name="nome" type="text" class="form-control input-borders" placeholder="Nome" style="padding:.5rem;border-radius:6px!important;">
                        <div class="invalid-feedback">Informe nome.</div>
                    </div>

                    <div class="col-md-3">
                        <input id="email" name="email" type="email" class="form-control input-borders" placeholder="e-mail" style="padding:.5rem;border-radius:6px!important;">
                    ...
                    <div class="col-md-3">
                        <input id="fone" name="telefone" type="text" class="form-control input-borders" placeholder="whatsapp" style="padding:.5rem;border-radius:6px!important;">
