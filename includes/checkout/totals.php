...
<div class="ck-card ck-card-price mb-3">
  <div class="ck-body p-3">
    ...
    <div id="totalEntradaValorFullLine" class="ck-muted mt-0" style="font-size:.82rem;display:none">
      <?= t('Total') ?> <strong id="totalEntradaValorFull">R$ 0,00</strong>
    </div>

    <div class="d-flex justify-content-between align-items-center small mt-2">
      <span class="ck-muted" id="entradaParcelaLabel"><?= t('{n}x no cartão', ['n' => 2]) ?></span>
    ...
    <div class="d-flex justify-content-between small mb-1">
      <span class="ck-muted"><?= t('Subtotal do projeto') ?></span>
      <span id="totalParceladoBruto" class="ck-muted">R$ 0,00</span>
    </div>
    <div class="d-flex justify-content-between small mb-2">
      <span class="ck-muted"><?= t('Restante (75%)') ?></span>
      <span id="totalSaldoBruto" class="ck-muted">R$ 0,00</span>
    </div>

    <div class="entrada-info-box" role="note">
      <?= t('<strong>📌 Importante:</strong> o restante de 75% só será cobrado quando você <strong>escolher o escritório</strong> que tocará seu projeto - parcelado em até <strong>10x</strong>.') ?>
    </div>

    <div class="entrada-info-box guarantee" role="note">
      <?= t('<strong>🛡️ Garantia de satisfação:</strong> se a experiência não atender suas expectativas, <strong>devolvemos seu dinheiro</strong>.') ?>
    </div>
