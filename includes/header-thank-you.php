        ...
        <nav class="navbar py-3 f-exo font-blue" id="navbar">
            ...
            <div class="container-lg d-flex align-items-center mt-3">
                ...
                <a class="navbar-brand me-2" href="https://www.archa.com.br">
                    <?php if (IS_MOBILE): ?>
                        <img src="images/logo-azul.png" alt="Archa" class="logo-mobile">
                    <?php else: ?>
                        <img src="images/logo-azul.png" alt="Archa" style="height: 26px;">
                    <?php endif; ?>
                </a>

                <!-- Ícones à direita, alinhados ao limite do container -->
                <div class="ms-auto d-flex align-items-center gap-3 icones-header">
                    <a href="https://api.whatsapp.com/send/?phone=5511942892984&text=Para+iniciar+seu+atendimento%2C+envie+uma+mensagem+como+esta%3A+Ol%C3%A1%21+Gostaria+de+contratar+um+projeto+de+arquitetura+com+a+Archa.+%EF%BF%BD&type=phone_number&app_absent=0" target="_blank" title="Fale conosco">
                        <img src="images/icon-whatsapp.png" alt="Link Whatsapp">
                    </a>
                </div>
