...
<head>
  ...
  <title>Finalizar contratação - Archa</title>
  <?php emit_robots(); emit_app_meta(null, false); emit_gtm_head(); ?>
...
<div id="payOverlay" class="pay-overlay"><div class="pay-overlay-inner"><div class="spinner-border text-light mb-2"></div><p>Processando...</p></div></div>
